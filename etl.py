...
def process_data(spark, input_data, output_data):
    ...
    catalog_data_url = input_data + "catalog.csv"
    ...
    # Merge the book_id with the file df
    ...
    # Generate list of sentences, words and syllables in each text
...
def main():
    ...
    if mode == 'emr':
        input_data = "s3://narrate-data/gutenberg-data/data/"
        output_data = "s3://narrate-data/gutenberg-data/results/"
    elif mode == 'local':
        input_data = "data/"
        output_data = "out/"
